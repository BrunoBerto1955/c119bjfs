...
function draw() {
  ...
  // Establece el grosor del stroke (trazo) a 8.
  strokeWeight(8);
...
function check_sketch() { timer_counter++; document.getElementById('time').innerHTML = 'Tiempo: ' + timer_counter; console.log(timer_counter) if(timer_counter > 400) { timer_counter = 0; timer_check = "completado" } if(timer_check =="completado" || answer_holder == "set") { timer_check = ""; answer_holder = ""; updateCanvas(); } }
